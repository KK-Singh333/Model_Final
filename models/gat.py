...
class GAT(torch.nn.Module):
    def __init__(self,args ,num_node_features, hidden_channels=64, num_heads=8, num_layers=2, dropout=0.6):
        ...
        # self.channels=int(args.up_dim_list[0])
        #print(args.up_dim_list)
        self.channels=int(args.up_dim_list)
        # First GAT layer
